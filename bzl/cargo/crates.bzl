...
def zexe_fetch_remote_crates():
    ...
    maybe(
        ...
        url = "https://crates.io/api/v1/crates/bstr/0.2.13/download",
        type = "tar.gz",
        sha256 = "31accafdb70df7871592c058eca3985b71104e15ac32f64706022c58867da931",
        strip_prefix = "bstr-0.2.13",
        build_file = Label("//bzl/cargo/remote:BUILD.bstr-0.2.13.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.crossbeam-channel-0.4.4.bazel"),
    )
    ...
    maybe(
        ...
        url = "https://crates.io/api/v1/crates/csv/1.1.3/download",
        type = "tar.gz",
        sha256 = "00affe7f6ab566df61b4be3ce8cf16bc2576bca0963ceb0955e45d514bf9a279",
        strip_prefix = "csv-1.1.3",
        build_file = Label("//bzl/cargo/remote:BUILD.csv-1.1.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.libc-0.2.79.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.memchr-2.3.3.bazel"),
    )
    ...
    maybe(
        ...
        url = "https://crates.io/api/v1/crates/oorandom/11.1.2/download",
        type = "tar.gz",
        sha256 = "a170cebd8021a008ea92e4db85a72f80b35df514ec664b296fdcbb654eac0b2c",
        strip_prefix = "oorandom-11.1.2",
        build_file = Label("//bzl/cargo/remote:BUILD.oorandom-11.1.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.ppv-lite86-0.2.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.proc-macro-hack-0.5.18.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.rayon-core-1.8.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.regex-1.4.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.regex-syntax-0.6.20.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bzl/cargo/remote:BUILD.smallvec-1.4.2.bazel"),
    )
