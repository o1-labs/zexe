...
pub extern "C" fn zexe_tweedle_fq_proof_verify(
    ...
    let retval = DlogProof::verify::<DefaultFqSponge<TweedledumParameters>, DefaultFrSponge<Fq>>(
        &group_map,
        &[proof].to_vec(),
        &index,
        &mut rand_core::OsRng,
...
pub extern "C" fn zexe_tweedle_fq_proof_batch_verify(
    ...
    let retval = DlogProof::<GAffine>::verify::<DefaultFqSponge<TweedledumParameters>, DefaultFrSponge<Fq>>(
        &group_map,
        proofs,
        index,
        &mut rand_core::OsRng,
