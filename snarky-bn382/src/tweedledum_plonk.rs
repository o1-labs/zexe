...
use plonk_circuits::gate::{CircuitGate, Gate, GateType};
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_zero(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Zero, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_generic(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Generic, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_poseidon(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Poseidon, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_add1(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Add1, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_add2(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Add2, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_vbmul1(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Vbmul1, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_vbmul2(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Vbmul2, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_vbmul3(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Vbmul3, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_endomul1(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Endomul1, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_endomul2(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Endomul2, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_endomul3(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Endomul3, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
...
pub extern "C" fn zexe_tweedle_plonk_fq_gate_vector_add_endomul4(
    ...
    zexe_tweedle_plonk_fq_gate_vector_add(v, Endomul4, l_index, l_permutation, r_index, r_permutation, o_index, o_permutation, c);
}
