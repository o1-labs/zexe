...
#[no_mangle]
pub extern "C" fn zexe_tweedle_fp_urs_delete(t : *mut SRS<GAffine>) {
...
#[no_mangle]
pub extern "C" fn zexe_tweedle_dee_affine_pair_delete(t : *mut (GAffine, GAffine)) {
    let _box = unsafe { Box::from_raw(t) };
}
...
#[no_mangle]
pub extern "C" fn zexe_tweedle_fp_proof_evaluations_delete(t : *mut DlogProofEvaluations<Fp>) {
    let _box = unsafe { Box::from_raw(t) };
}
